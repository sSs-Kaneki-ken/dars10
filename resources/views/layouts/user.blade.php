...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('user-styles/css/vendor.css')}}">
    ...
    <div class="container-fluid">
        <div class="row py-3 border-bottom">
            ...
            <div class="col-sm-4 col-lg-3 text-center text-sm-start">
                <div class="main-logo">
                    <a>
                        <img src="{{asset('user-styles/images/logo.png')}}" alt="logo" class="img-fluid">
                    </a>
                </div>
            </div>
                        ...
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="{{asset($post->image)}}"
                                     style="width: 260px; height: 260px; border: 2px solid black" alt="post"
                                     class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body" style="border: 2px solid black; width: 260px; height: 280px;" >
                            ...
                            <div class="post-header">
                                ...
                                <hr>
                                <p style="font-family: 'JetBrains Mono Medium'; font-size: 10px">{{$post->description}}</p>
                            </div>
                        </div>
                    </article>
                </div>
...
<script src="{{asset('user-styles/js/jquery-1.11.0.min.js')}}"></script>
<script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe"
        crossorigin="anonymous"></script>
<script src="{{asset('user-styles/js/plugins.js')}}"></script>
<script src="{{asset('user-styles/js/script.js')}}"></script>
</body>
</html>
